...
```shell
  docker buildx build -t leonjza/docker-extension:latest . --load
```

To install the extension, use `make install-extension` **or**:

```shell
  docker extension install leonjza/docker-extension:latest
```
...
```shell
  docker extension dev ui-source leonjza/docker-extension:latest http://localhost:3000
```

In order to open the Chrome Dev Tools for your extension when you click on the extension tab, run:

```shell
  docker extension dev debug leonjza/docker-extension:latest
```

Each subsequent click on the extension tab will also open Chrome Dev Tools. To stop this behaviour, run:

```shell
  docker extension dev reset leonjza/docker-extension:latest
```
...
```shell
docker extension update leonjza/docker-extension:latest
```
...
```shell
docker extension rm leonjza/docker-extension:latest
```
